...
import 'package:project_uas/pages/landingpage.dart';
import 'package:project_uas/pages/mainpage.dart';
import 'package:project_uas/pages/registerpage.dart';
                    ...
                    GestureDetector(
                      onTap: () {
                        final snackBar = SnackBar(
                          content: Text('Maaf, Fitur ini belum tersedia.'),
                        );
